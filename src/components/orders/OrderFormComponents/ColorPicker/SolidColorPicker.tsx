...
const SolidColorPicker = ({
  ...
  return <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
      ...
      return <div key={color.value} className={`h-12 rounded-md cursor-pointer border-2 flex items-center justify-center ${value === color.value ? "border-primary" : "border-transparent"}`} style={{
